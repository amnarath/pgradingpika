/*
  # Add Pending status and update payment validation

  1. Changes
    - Add 'Pending' status to grading_status enum
    - Update existing entries to use new status
    - Update payment validation for Pending status
    - Maintain data integrity during migration

  2. Security
    - Temporarily disable triggers during migration
    - Re-enable triggers after changes
    - Update validation function for new status
*/
